namespace rsvsport_logiciel
{
    partial class Foot
    {
        ...
        private void InitializeComponent()
        {
            ...
            label13.Size = new Size(72, 14);
            label13.TabIndex = 177;
            label13.Text = "6 = San Siro";
            // 
            // label12
            // 
            ...
            label17.Size = new Size(73, 14);
            label17.TabIndex = 138;
            label17.Text = "2 = Football";
            // 
            // label7
            // 
            ...
            label4.TabIndex = 73;
            label4.Text = "Gestion des réservations de stade de Football";
            // 
            // Comm
            // 
            Comm.AutoSize = true;
            ...
            NomStades.Items.AddRange(new object[] { "2", "6" });
            ...
            IdTypeStade.Items.AddRange(new object[] { "2" });
